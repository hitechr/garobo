...
public class Entities {
    ...
    private static final String[][] COOKIE_SET = new String[][]{{"#61", "61"}, {"#44", "44"}};
    ...
    public void addEntity(String name, int value) {
        ...
        this.entityValueToName.put(Integer.valueOf(value), name);
    ...
    public String getEntityName(int value) {
        if(value >= 256) {
            return (String)this.entityValueToName.get(Integer.valueOf(value));
        } else {
            if(this.lookupTable == null) {
                this.lookupTable = new String[256];

                for(int i = 0; i < 256; ++i) {
                    this.lookupTable[i] = (String)this.entityValueToName.get(Integer.valueOf(i));
                }
            }
